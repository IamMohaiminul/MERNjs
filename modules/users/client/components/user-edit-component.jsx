      ...
      <div className='row'>
        <div className='col-xs-12'>
          ...
          {this.props.user
                ...
                <form className='form-horizontal' onSubmit={this.handleSubmit.bind(this)}>
                  ...
                  <div className='form-group'>
                    ...
                    <div className='col-xs-5'>
                      <button type='submit' className='btn btn-primary btn-block btn-flat'>Edit User</button>
                    </div>
                  </div>
                </form>
                {/* User delete confirmation modal */}
                <div id='userDeleteConfirm' className='modal fade' tabIndex='-1' role='dialog'>
            ...
            : <p><b><i>Please select a user...</i></b></p>
          }
        </div>
      </div>
    );
